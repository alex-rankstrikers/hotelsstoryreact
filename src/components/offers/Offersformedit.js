...
function MyOfferEditList(props) {
...
const [offer_code, setOffer_code] = React.useState("");
  ...
  const handleChangeMultiple = (event) => {
    ...
    function uploadWithFormData(){
     ...
     //console.log("Success Data####"+JSON.stringify(msg))
      ...
      console.log("Data######"+JSON.stringify(offer))
          ...
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} sm={12} md={9} >             
              <Paper className="m-b-10" p={5}>
               <Box p={3} fontWeight="fontWeightBold" textAlign="left" fontSize={18} >Edit Rewards / Deals</Box>
 ...
 <Grid item xs={6} sm={12} md={6} spacing={2}> <FormControl component="fieldset" fullWidth>
                      <TextField fullWidth id="standard-basic" type="file" name="file" label="Upload PDF file" onChange={(e) => setFile(e.target.files[0])}/> </FormControl>
                      </Grid>
...
export default MyOfferEditList
