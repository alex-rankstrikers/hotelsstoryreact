          ...
          <Grid container spacing={2} >
            <Grid item xs={12} sm={12} md={9}>
              <Paper className={classes.profileContainer}>
                ...
                <Box fontWeight="fontWeightBold" textAlign="left" fontSize={18} mt={3} p={2}>first_name</Box>
              ...
              <Paper className={'m-t-10'}>
                <Box p={5}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={12} md={1}>
                      <Link href="#"> <AddRoundedIcon className={classes.addplusicon} fontSize="large" /></Link>
                    ...
                    <Grid item xs={12} sm={12} md={1}>
                      <Link href="#" fontSize={10}> <EditRoundedIcon className={classes.editpencilicon} /></Link>
                    </Grid>
