...
const initEvent = {user_id:user_id, hotel_id: '', arrive: '', depart: '', date_flex: '', extend_stays: '', 
...
<Grid item xs={12} sm={12} md={3} className="p-20"><p><b>Are your dates are flexible</b><br/>
...
<Grid item xs={12} sm={12} md={3} className="p-20"><p><b>Total number of children</b><br/>
<TextField style={{minWidth:"80%"}}
id="outlined-size-small"
name="no_of_children"
variant="outlined"
